            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <div class="col-1 offset-3 pr-0 mt-3 text-right">
                                <input id="checkbox-confirm" type="checkbox" class="form-check-input text-right" name="checkbox_confirmation" style="opacity: 1; pointer-events: auto;" required>
                            </div>
                            <label for="checkbox-confirm" class="col-6 col-form-label">{{ __('Acepto manejo de datos personales') }}</label>
                        </div>
