                ...
                <div class="col-xl-7 col-md-10">
                    <div class="card user-card-full">
                        <div class="row m-l-0 m-r-0 mb-0">
                            <div class="col-sm-4 user-profile position-relative m-auto">
                                <img class="w-100"
                            ...
                            <div class="col-sm-8 bg-c-lite-green">
                                ...
                                <form action="/productos/{{ $producto->id }}" method="POST" enctype="multipart/form-data" class="w-100" >
                                    @csrf
                                    @method('put')
                                    <div class="row ">
                                    ...
                                    <div class="row">
                                        <div class="input-field col s12">
                                            <select id="tipo" class="browser-default bg-c-lite-green" name="tipo" required>
